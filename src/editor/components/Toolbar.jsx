...
const tools = [
    { id: 'select', label: 'Select', icon: 'M3,3L10,20L13,14L19,17L3,3Z' },
    { id: 'rect', label: 'Rectangle', icon: 'M3,3H21V21H3V3M5,5V19H19V5H5Z' },
    { id: 'roundrect', label: 'Rounded Rect', icon: 'M7,3H17A4,4,0,0,1,21,7V17A4,4,0,0,1,17,21H7A4,4,0,0,1,3,17V7A4,4,0,0,1,7,3Z' },
    { id: 'ellipse', label: 'Ellipse', icon: 'M12,2A10,10,0,1,0,22,12A10,10,0,0,0,12,2M12,4A8,8,0,1,1,4,12A8,8,0,0,1,12,4Z' },
    ...
    { id: 'pen', label: 'Pen', icon: 'M12,2L2,22H6L8,17H16L18,22H22L12,2Z M9.5,14L12,6L14.5,14H9.5Z' },
    { id: 'pencil', label: 'Pencil', icon: 'M3,21L4.5,15.5L17,3L21,7L8.5,19.5L3,21Z M14.5,5.5L18.5,9.5' },
    { id: 'text', label: 'Text', icon: 'M5,4V7H10.5V19H13.5V7H19V4H5Z' },
    ...
    { id: 'pan', label: 'Pan', icon: 'M12,2L9,5H11V11H5V9L2,12L5,15V13H11V19H9L12,22L15,19H13V13H19V15L22,12L19,9V11H13V5H15L12,2Z' },
